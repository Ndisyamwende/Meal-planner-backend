...
@app.get('/preference/{preference_id}', status_code=status.HTTP_200_OK, response_model=schemas.ShowPreferences, tags=['preferences'])
def get_preference(preference_id: int,response: Response, db: Session = Depends(get_db)):
